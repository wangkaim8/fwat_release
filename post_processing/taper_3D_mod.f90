...
contains
    subroutine Create(this, xmin, xmax, ymin, ymax, zmin, zmax, hx, hy, hz, &
        ...
        real :: xmin, xmax, ymin, ymax, zmin, zmax, hx, hy, hz, taph1, taph2, tapz
        integer :: nx, ny, nz, i
        ...
        enddo
        call create_taper(taph1, taph2, tapz, hx, hy, hz, nx, ny, nz, this%taper)
    ...
    subroutine create_taper(taph1, taph2, tapz, hx, hy, hz, nx, ny, nz, taper)
        integer :: nh1, nh2, nhz, x1, x2, x3, x4, y1, y2, y3, y4, nx, ny, nz, i, j, k
        real :: hx, hy, hz, taph1, taph2, tapz
        ...
        nhz = floor(tapz/hz)
        call coswin(nhz, 1, ztaper(1:nhz))
        ztaper(nhz+1:nz) = 1.
