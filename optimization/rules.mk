...
$O/%.opt_module.o: $S/%.f90 ${SETUP}/constants_tomography.h $O/shared_par.shared_module.o $O/specfem3D_par.spec_module.o
	${FCCOMPILE_CHECK} ${FCFLAGS_f90} -c -o $@ $<

$O/%.opt.o: $S/%.f90 ${SETUP}/constants_tomography.h $O/tomography_par.opt_module.o
	${FCCOMPILE_CHECK} ${FCFLAGS_f90} -c -o $@ $<
